...
@NamedQueries({
		...
		@NamedQuery(name = "DadosMunicipio.ultimoIDHParaMunicipios", query = "SELECT d FROM DadosMunicipio d WHERE d.municipio.id IN :ids AND d.idhm > 0 AND d.ano <= :ano", hints = { @QueryHint(name = "org.hibernate.cacheable", value = "true") }) 
