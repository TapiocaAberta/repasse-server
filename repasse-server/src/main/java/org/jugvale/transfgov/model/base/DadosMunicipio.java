...
@NamedQueries({
		...
		@NamedQuery(name = "DadosMunicipio.ultimoIDHParaMunicipios", query = "SELECT d FROM DadosMunicipio d WHERE d.municipio.id IN :ids AND d.idhm > 0", hints = { @QueryHint(name = "org.hibernate.cacheable", value = "true") }) 
