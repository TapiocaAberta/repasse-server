...
@NamedQueries({
		...
		@NamedQuery(name = "Transferencia.porAnoAgrupadoPorArea", query = "SELECT t.area.nome, sum(t.valor) from Transferencia t WHERE t.ano = :ano AND t.municipio.nome <> 'Governo do Estado' GROUP BY t.area", hints = { @QueryHint(name = "org.hibernate.cacheable", value = "true") }),
		@NamedQuery(name = "Transferencia.porAnoMesAgrupadoPorArea", query = "SELECT t.area.nome, sum(t.valor) from Transferencia t WHERE t.ano = :ano AND t.mes = :mes AND t.municipio.nome <> 'Governo do Estado' GROUP BY t.area", hints = { @QueryHint(name = "org.hibernate.cacheable", value = "true") }),
		@NamedQuery(name = "Transferencia.porAnoAgrupadoPorAcao", query = "SELECT concat(t.acao.nome, ' - ', t.acao.codigo), sum(t.valor) from Transferencia t WHERE t.ano = :ano AND t.municipio.nome <> 'Governo do Estado' GROUP BY t.acao", hints = { @QueryHint(name = "org.hibernate.cacheable", value = "true") }),
		@NamedQuery(name = "Transferencia.porAnoAgrupadoPorPrograma", query = "SELECT t.programa.nome, sum(t.valor) from Transferencia t WHERE t.ano = :ano AND t.municipio.nome <> 'Governo do Estado' GROUP BY t.programa", hints = { @QueryHint(name = "org.hibernate.cacheable", value = "true") }),
		@NamedQuery(name = "Transferencia.porAnoAgrupadoPorSubFuncao", query = "SELECT t.subFuncao, sum(t.valor) from Transferencia t WHERE t.ano = :ano AND t.municipio.nome <> 'Governo do Estado' GROUP BY t.subFuncao", hints = { @QueryHint(name = "org.hibernate.cacheable", value = "true") }),
		@NamedQuery(name = "Transferencia.porAnoAgrupadoPorFavorecido", query = "SELECT t.favorecido, sum(t.valor) from Transferencia t WHERE t.ano = :ano AND t.municipio.nome <> 'Governo do Estado' GROUP BY t.favorecido", hints = { @QueryHint(name = "org.hibernate.cacheable", value = "true") }), })
